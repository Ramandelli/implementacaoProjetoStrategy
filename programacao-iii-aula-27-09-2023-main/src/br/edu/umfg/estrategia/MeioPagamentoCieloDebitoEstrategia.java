...
public class MeioPagamentoCieloDebitoEstrategia implements MeioPagamentoEstrategia {
    ...
    public MeioPagamentoCieloDebitoEstrategia(String numeroCartao, String cpf, String dataValidade) {
    ...
    public void pagar(Double valor) {
        if (validarNumeroCartao() && validarCPF() && validarDataValidade()) {
            System.out.printf("Pagamento via Cielo com Cartão de Débito no valor %.2f realizado com sucesso.\n", valor);
        } else {
            System.out.println("Falha no pagamento. Verifique os dados do cartão de débito.");
        }
    }
